...
bucket_name="gov-dos-producer-global-p-shoreline"

# CSV file path
csv_file="prod-Shorelinecdc&truncate-folders-s3-sizes.csv"
...
# Email the CSV file
echo "Please find attached the CSV file." | mailx -s "S3 Folder Sizes Report (Runtime: ${runtime} seconds)" -a "$csv_file" chinnapareddy.mora@ge.com
